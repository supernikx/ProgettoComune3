...
namespace JoshH.UI
{
    ...
    public class UIGradient : BaseMeshEffect
    {
        ...
        Vector2 GetCutDirection()
        {
            ...
            v.Scale(Vector2.one / this.rectTransform.rect.size);
            return v.Rotate(90);
        }
        ...
        Vector2 GetCutOrigin(float f)
        {
            ...
            if (angle % 180 < 90)
            {
                p1 = Vector3.Project(rectTransform.rect.size * (Vector2.down + Vector2.left) * 0.5f, v);
                p2 = Vector3.Project(rectTransform.rect.size * (Vector2.up + Vector2.right) * 0.5f, v);
            }
            else
            {
                p1 = Vector3.Project(rectTransform.rect.size * (Vector2.up + Vector2.left) * 0.5f, v);
                p2 = Vector3.Project(rectTransform.rect.size * (Vector2.down + Vector2.right) * 0.5f, v);
            }
            if (angle % 360 >= 180)
            {
